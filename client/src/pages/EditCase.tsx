...
export default function EditCase() {
  ...
  useEffect(() => {
    if (caseData && !initialized) {
      setFormData({
        ...
        cha9a9aLink: caseData.cha9a9aLink,
        targetAmount: String(caseData.targetAmount),
  ...
  const updateCaseMutation = trpc.cases.update.useMutation({
    onSuccess: () => {
      toast.success(t("editCase.success"));
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-indigo-100 dark:from-zinc-950 dark:via-purple-950/30 dark:to-zinc-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">{t("editCase.onlyAssociationsAdmins")}</p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-indigo-100 dark:from-zinc-950 dark:via-purple-950/30 dark:to-zinc-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">{t("editCase.mustBeLoggedIn")}</p>
          <Button asChild size="lg" className="rounded-2xl">
  ...
  if (!caseData) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-indigo-100 dark:from-zinc-950 dark:via-purple-950/30 dark:to-zinc-950 flex items-center justify-center">
        <div className="text-center">
          <Heart className="h-16 w-16 text-muted-foreground mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-foreground mb-2">{t("editCase.notFound")}</h2>
          <Button asChild size="lg" className="rounded-2xl">
            <Link href="/">{t("common.backToHome")}</Link>
          </Button>
        </div>
  ...
  // Ownership check
  if (user?.role === "association" && caseData.associationId !== user.id) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-indigo-100 dark:from-zinc-950 dark:via-purple-950/30 dark:to-zinc-950 flex items-center justify-center">
        <div className="text-center">
          <Heart className="h-16 w-16 text-muted-foreground mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-foreground mb-2">{t("common.accessDenied")}</h2>
          <p className="text-muted-foreground mb-6">{t("editCase.cannotEditOthers")}</p>
          <Button asChild size="lg" className="rounded-2xl">
            <Link href="/">{t("common.backToHome")}</Link>
          </Button>
        </div>
        ...
        <div className="container max-w-3xl mx-auto px-6">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-3 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md px-6 py-3 rounded-3xl mb-6 shadow">
              ...
              <span className="text-xl font-semibold">Modifier le cas</span>
            </div>
            <h1 className="text-5xl font-bold tracking-tighter mb-3">Mettre à jour le cas solidaire</h1>
            <p className="text-lg text-muted-foreground max-w-md mx-auto">
              Modifiez les informations de votre appel à solidarité
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="description"
                    rows={7}
                    placeholder="Décrivez la situation avec compassion..."
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  >
                    {updateCaseMutation.isPending ? "Enregistrement..." : "Enregistrer les modifications"}
                  </Button>
                  <Button type="button" variant="outline" asChild className="h-14 rounded-3xl">
                    <Link href={`/case/${caseId}`}>Annuler</Link>
                  </Button>
                </div>
              </form>
            </CardContent>
